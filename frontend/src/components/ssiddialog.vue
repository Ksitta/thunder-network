    ...
    <div class="set_ssid">
        <el-dialog
            ...
            <div class="wlan_set" style="margin-top: -20px">
                <el-form class="form" ref="form" label-width="100px" label-position="left">
                    <el-form-item label="WLAN" class="label-style">
                        <el-switch v-model="wlan_info.enable" style="margin-right: 300px;"></el-switch>
                    </el-form-item>
                    <el-form-item label="WLAN名称:" class="label-style">
                    ...
                    <el-form-item label="用户隔离" class="label-style">
                        <el-switch v-model="wlan_info.userSeparation" style="margin-right: 300px;"></el-switch>
                    </el-form-item>
                    <el-form-item label="SSID认证" class="label-style">
                    ...
                    <el-form-item label="SSID安全模式" class="label-style" v-if="wlan_info.ssidAuth.mode == 'psk'">
                    ...
                    <el-form-item label="SSID安全模式" class="label-style" v-if="wlan_info.ssidAuth.mode == 'ppsk'">
                        <el-radio-group v-model="wlan_info.ssidAuth.pskEncryptType" class="wlan_input" style="margin-left: -17px">
                    ...
                    <el-form-item label="WIFI密码:" class="label-style" v-if="wlan_info.ssidAuth.pskEncryptType == 'wep'">
                        <el-input class="wlan_input" v-model="wlan_info.ssidAuth.securityKey" placeholder="仅可接受字符串与数字，长度为5位" size="medium" type="password" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="WIFI密码:" class="label-style" v-if="wlan_info.ssidAuth.pskEncryptType != 'wep'">
                        <el-input class="wlan_input" v-model="wlan_info.ssidAuth.securityKey" placeholder="请设置密码，不接受问号与空格" size="medium" type="password" clearable></el-input>
                    </el-form-item>
