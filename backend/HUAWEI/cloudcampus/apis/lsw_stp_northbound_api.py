...
class LSWStpNorthboundApi(object):
    """
    ...
    def config(self, site_id, body, **kwargs):
        ...
        :param StpDto body: 站点内交换机的STP配置参数体。 (required)
    ...
    def config_with_http_info(self, site_id, body, **kwargs):
        ...
        return self.api_client.call_api('/controller/campus/v1/networkservice/networkconfig/net/lswstp/sites/{siteId}/stp', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete(self, site_id, body, **kwargs):
        """
        删除站点内交换机的STP配置
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete(site_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str site_id: 站点ID。 (required)
        :param DelStpDto body: 站点内交换机的STP配置参数体。 (required)
        :return: StpResponseDto
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_with_http_info(site_id, body, **kwargs)
        else:
            (data) = self.delete_with_http_info(site_id, body, **kwargs)
            return data

    def delete_with_http_info(self, site_id, body, **kwargs):
        """
        删除站点内交换机的STP配置
        ## 典型场景 ##    提供配置参数的接口，删除交换机MSTP配置。    1、若只传入regionId，删除对应的MSTPregion；    2、若只传入regionId和instanceId，则删除指定regionId下的instanceId对应的mstpRegionInstance；    3、若只传入regionId和deviceId，则删除指定regionId下的regionDeviceList中的deviceId，且会删除指定regionID下，所有instance下的deviceId对应的regionInstanceDevice；    4、若传入regionId、instanceId和deviceId，只删除指定regionId下指定instanceId下的regionInstanceDevice，instanceId为0的树无法删除。 ## 接口功能 ##    删除交换机STP配置。 ## 接口约束 ##    该接口必须在租户内，存在交换机设备的站点内使用。 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_with_http_info(site_id, body, callback=callback_function)
        ...
        # verify the required parameter 'site_id' is set
        if ('site_id' not in params) or (params['site_id'] is None):
            raise ValueError("Missing the required parameter `site_id` when calling `delete`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
        ...
        return self.api_client.call_api('/controller/campus/v1/networkservice/networkconfig/net/lswstp/sites/{siteId}/action/batch-delete', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_config_with_http_info(self, site_id, **kwargs):
        ...
        return self.api_client.call_api('/controller/campus/v1/networkservice/networkconfig/net/lswstp/sites/{siteId}/stp', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def incre_config(self, site_id, body, **kwargs):
        """
        增量修改站点内交换机的STP配置
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.incre_config(site_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str site_id: 站点ID。 (required)
        :param IncreStpDto body: 站点内交换机的STP配置参数体。 (required)
        :return: StpResponseDto
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.incre_config_with_http_info(site_id, body, **kwargs)
        else:
            (data) = self.incre_config_with_http_info(site_id, body, **kwargs)
            return data

    def incre_config_with_http_info(self, site_id, body, **kwargs):
        """
        增量修改站点内交换机的STP配置
        ## 典型场景 ##    提供配置参数的接口，增量修改交换机MSTP配置，根据regionId\\instanceId\\deviceId将输入的内容进行修改，未输入的内容保持不变；若要向树中加入该域未包含的设备，需要同时将该设备加入域（regionDeviceList）中。 ## 接口功能 ##    增量修改交换机STP配置。 ## 接口约束 ##    该接口必须在租户内，存在交换机设备的站点内使用。 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.incre_config_with_http_info(site_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method incre_config" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'site_id' is set
        if ('site_id' not in params) or (params['site_id'] is None):
            raise ValueError("Missing the required parameter `site_id` when calling `incre_config`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `incre_config`")
        ...
        return self.api_client.call_api('/controller/campus/v1/networkservice/networkconfig/net/lswstp/sites/{siteId}/stp-increment', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
