...
class DomainNameNorthboundApi(object):
    """
    ...
    def config(self, site_id, body, **kwargs):
        ...
        :param DomainNameDto body: 站点内设备域名配置参数体。 (required)
    ...
    def config_with_http_info(self, site_id, body, **kwargs):
        ...
        return self.api_client.call_api('/controller/campus/v1/networkservice/networkconfig/net/domainname/sites/{siteId}/domainnames', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='DomainNameResponseDto',
    ...
    def get_config_with_http_info(self, site_id, **kwargs):
        ...
        return self.api_client.call_api('/controller/campus/v1/networkservice/networkconfig/net/domainname/sites/{siteId}/domainnames', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
