...
class ApExtraServiceNorthboundApi(object):
    """
    ...
    def config(self, site_id, body, **kwargs):
        ...
        :param ApExtraServiceInputDto body: 站点内AP增值服务配置参数体。 (required)
    ...
    def config_with_http_info(self, site_id, body, **kwargs):
        ...
        return self.api_client.call_api('/controller/campus/v1/networkservice/networkconfig/net/apextraservice/sites/{siteId}/apextraservices', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ApExtraServiceResponseDto',
    ...
    def get_config_with_http_info(self, site_id, **kwargs):
        ...
        return self.api_client.call_api('/controller/campus/v1/networkservice/networkconfig/net/apextraservice/sites/{siteId}/apextraservices', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
