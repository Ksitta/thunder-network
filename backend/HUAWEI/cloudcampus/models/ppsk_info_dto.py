...
class PPSKInfoDto(object):
    ...
    def __init__(self, psk=None, vlan=None, description=None, acc_dev_num=None, mac_address=None, ssid_name=None, account=None):
        """
        PPSKInfoDto - a model defined in Swagger
        """
    ...
    def psk(self):
        """
        Gets the psk of this PPSKInfoDto.
        接入密钥。

        :return: The psk of this PPSKInfoDto.
        :rtype: str
        """
        return self._psk
    ...
    def psk(self, psk):
        """
        Sets the psk of this PPSKInfoDto.
        接入密钥。

        :param psk: The psk of this PPSKInfoDto.
        :type: str
        """
    ...
    def vlan(self):
        """
        Gets the vlan of this PPSKInfoDto.
        绑定VLAN，值为0表示不绑定VLAN。

        :return: The vlan of this PPSKInfoDto.
        :rtype: int
        """
        return self._vlan
    ...
    def vlan(self, vlan):
        """
        Sets the vlan of this PPSKInfoDto.
        绑定VLAN，值为0表示不绑定VLAN。

        :param vlan: The vlan of this PPSKInfoDto.
        :type: int
        """
    ...
    def description(self):
        """
        Gets the description of this PPSKInfoDto.
        描述。

        :return: The description of this PPSKInfoDto.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this PPSKInfoDto.
        描述。

        :param description: The description of this PPSKInfoDto.
        :type: str
        """
    ...
    def acc_dev_num(self):
        """
        Gets the acc_dev_num of this PPSKInfoDto.
        接入终端数，值为0表示不限制接入终端数。

        :return: The acc_dev_num of this PPSKInfoDto.
        :rtype: int
        """
    ...
    def acc_dev_num(self, acc_dev_num):
        """
        Sets the acc_dev_num of this PPSKInfoDto.
        接入终端数，值为0表示不限制接入终端数。

        :param acc_dev_num: The acc_dev_num of this PPSKInfoDto.
        :type: int
        """
    ...
    def mac_address(self):
        """
        Gets the mac_address of this PPSKInfoDto.
        帐号绑定的MAC地址。

        :return: The mac_address of this PPSKInfoDto.
        :rtype: str
        """
    ...
    def mac_address(self, mac_address):
        """
        Sets the mac_address of this PPSKInfoDto.
        帐号绑定的MAC地址。

        :param mac_address: The mac_address of this PPSKInfoDto.
        :type: str
        """
    ...
    def ssid_name(self):
        """
        Gets the ssid_name of this PPSKInfoDto.
        SSID名称。

        :return: The ssid_name of this PPSKInfoDto.
        :rtype: str
        """
    ...
    def ssid_name(self, ssid_name):
        """
        Sets the ssid_name of this PPSKInfoDto.
        SSID名称。

        :param ssid_name: The ssid_name of this PPSKInfoDto.
        :type: str
        """
    ...
    def account(self):
        """
        Gets the account of this PPSKInfoDto.
        PPSK帐号名称。

        :return: The account of this PPSKInfoDto.
        :rtype: str
        """
    ...
    def account(self, account):
        """
        Sets the account of this PPSKInfoDto.
        PPSK帐号名称。

        :param account: The account of this PPSKInfoDto.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PPSKInfoDto):
            return False
