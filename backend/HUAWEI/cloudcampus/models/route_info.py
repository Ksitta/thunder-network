...
class RouteInfo(object):
    ...
    def __init__(self, mask=None, description=None, next_address=None, destination_ip=None, priority=None, next_interface=None, nqa_id=None, nqa_admin_name=None, nqa_test_name=None, dhcp=None, next_logic_interface=None):
        """
        RouteInfo - a model defined in Swagger
        """
    ...
    def mask(self):
        """
        Gets the mask of this RouteInfo.
        掩码，0-32。创建后不允许修改。

        :return: The mask of this RouteInfo.
        :rtype: str
        """
        return self._mask
    ...
    def mask(self, mask):
        """
        Sets the mask of this RouteInfo.
        掩码，0-32。创建后不允许修改。

        :param mask: The mask of this RouteInfo.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this RouteInfo.
        描述。

        :return: The description of this RouteInfo.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this RouteInfo.
        描述。

        :param description: The description of this RouteInfo.
        :type: str
        """
    ...
    def next_address(self):
        """
        Gets the next_address of this RouteInfo.
        下一跳地址，必须是合法的IPv4地址，以127或者224~255开头的IP地址为非法IP地址。当nextInterface为空时，nextAddress必填。

        :return: The next_address of this RouteInfo.
        :rtype: str
        """
    ...
    def next_address(self, next_address):
        """
        Sets the next_address of this RouteInfo.
        下一跳地址，必须是合法的IPv4地址，以127或者224~255开头的IP地址为非法IP地址。当nextInterface为空时，nextAddress必填。

        :param next_address: The next_address of this RouteInfo.
        :type: str
        """
    ...
    def destination_ip(self):
        """
        Gets the destination_ip of this RouteInfo.
        目的IP地址，创建后不允许修改。必须是合法的IPv4地址，以127或者224~255开头的IP地址为非法IP地址。

        :return: The destination_ip of this RouteInfo.
        :rtype: str
        """
    ...
    def destination_ip(self, destination_ip):
        """
        Sets the destination_ip of this RouteInfo.
        目的IP地址，创建后不允许修改。必须是合法的IPv4地址，以127或者224~255开头的IP地址为非法IP地址。

        :param destination_ip: The destination_ip of this RouteInfo.
        :type: str
        """
    ...
    def next_interface(self):
        """
        Gets the next_interface of this RouteInfo.
        路由出接口。当nextAddress为空时，nextInterface必填。

        :return: The next_interface of this RouteInfo.
        :rtype: str
        """
    ...
    def next_interface(self, next_interface):
        """
        Sets the next_interface of this RouteInfo.
        路由出接口。当nextAddress为空时，nextInterface必填。

        :param next_interface: The next_interface of this RouteInfo.
        :type: str
        """
    ...
    def nqa_id(self):
        """
        Gets the nqa_id of this RouteInfo.
        NQA的ID。

        :return: The nqa_id of this RouteInfo.
        :rtype: str
        """
        return self._nqa_id
    ...
    def nqa_id(self, nqa_id):
        """
        Sets the nqa_id of this RouteInfo.
        NQA的ID。

        :param nqa_id: The nqa_id of this RouteInfo.
        :type: str
        """
    ...
    def nqa_admin_name(self):
        """
        Gets the nqa_admin_name of this RouteInfo.
        NQA的admin名称。

        :return: The nqa_admin_name of this RouteInfo.
        :rtype: str
        """
    ...
    def nqa_admin_name(self, nqa_admin_name):
        """
        Sets the nqa_admin_name of this RouteInfo.
        NQA的admin名称。

        :param nqa_admin_name: The nqa_admin_name of this RouteInfo.
        :type: str
        """
    ...
    def nqa_test_name(self):
        """
        Gets the nqa_test_name of this RouteInfo.
        NQA的测试名称。

        :return: The nqa_test_name of this RouteInfo.
        :rtype: str
        """
    ...
    def nqa_test_name(self, nqa_test_name):
        """
        Sets the nqa_test_name of this RouteInfo.
        NQA的测试名称。

        :param nqa_test_name: The nqa_test_name of this RouteInfo.
        :type: str
        """
    ...
    def dhcp(self):
        """
        Gets the dhcp of this RouteInfo.
        DHCP开关使能。当nextAddress非空时，dhcp必须为false。

        :return: The dhcp of this RouteInfo.
        :rtype: bool
        """
        return self._dhcp
    ...
    def dhcp(self, dhcp):
        """
        Sets the dhcp of this RouteInfo.
        DHCP开关使能。当nextAddress非空时，dhcp必须为false。

        :param dhcp: The dhcp of this RouteInfo.
        :type: bool
        """
    ...
    def next_logic_interface(self):
        """
        Gets the next_logic_interface of this RouteInfo.
        逻辑出接口。

        :return: The next_logic_interface of this RouteInfo.
        :rtype: str
        """
    ...
    def next_logic_interface(self, next_logic_interface):
        """
        Sets the next_logic_interface of this RouteInfo.
        逻辑出接口。

        :param next_logic_interface: The next_logic_interface of this RouteInfo.
        :type: str
        """
