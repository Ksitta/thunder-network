...
class IotCardDto(object):
    ...
    def __init__(self, card_name=None, port_type=None, communication_port=None, communication_protocol=None, share_key=None, trusted_host_address=None, iot_server2=None, port2=None, administrative_status=None, default_vlan=None, description=None, iot_server1_config=None):
        """
        IotCardDto - a model defined in Swagger
        """
    ...
    def card_name(self):
        """
        Gets the card_name of this IotCardDto.
        插卡名称

        :return: The card_name of this IotCardDto.
        :rtype: str
        """
    ...
    def card_name(self, card_name):
        """
        Sets the card_name of this IotCardDto.
        插卡名称

        :param card_name: The card_name of this IotCardDto.
        :type: str
        """
    ...
    def port_type(self):
        """
        Gets the port_type of this IotCardDto.
        端口类型。ethernet---以太网口，serial---串口。

        :return: The port_type of this IotCardDto.
        :rtype: str
        """
    ...
    def port_type(self, port_type):
        """
        Sets the port_type of this IotCardDto.
        端口类型。ethernet---以太网口，serial---串口。

        :param port_type: The port_type of this IotCardDto.
        :type: str
        """
    ...
    def communication_port(self):
        """
        Gets the communication_port of this IotCardDto.
        通信端口。

        :return: The communication_port of this IotCardDto.
        :rtype: int
        """
    ...
    def communication_port(self, communication_port):
        """
        Sets the communication_port of this IotCardDto.
        通信端口。

        :param communication_port: The communication_port of this IotCardDto.
        :type: int
        """
    ...
    def communication_protocol(self):
        """
        Gets the communication_protocol of this IotCardDto.
        通信协议。

        :return: The communication_protocol of this IotCardDto.
        :rtype: str
        """
    ...
    def communication_protocol(self, communication_protocol):
        """
        Sets the communication_protocol of this IotCardDto.
        通信协议。

        :param communication_protocol: The communication_protocol of this IotCardDto.
        :type: str
        """
    ...
    def share_key(self):
        """
        Gets the share_key of this IotCardDto.
        共享秘钥，至少包含小写字母、大写字母、数字、特殊符号（除问号和空格）中的两种，不能包含全角字符。

        :return: The share_key of this IotCardDto.
        :rtype: str
        """
    ...
    def share_key(self, share_key):
        """
        Sets the share_key of this IotCardDto.
        共享秘钥，至少包含小写字母、大写字母、数字、特殊符号（除问号和空格）中的两种，不能包含全角字符。

        :param share_key: The share_key of this IotCardDto.
        :type: str
        """
    ...
    def trusted_host_address(self):
        """
        Gets the trusted_host_address of this IotCardDto.
        信任主机地址，格式为IP/掩码。

        :return: The trusted_host_address of this IotCardDto.
        :rtype: str
        """
    ...
    def trusted_host_address(self, trusted_host_address):
        """
        Sets the trusted_host_address of this IotCardDto.
        信任主机地址，格式为IP/掩码。

        :param trusted_host_address: The trusted_host_address of this IotCardDto.
        :type: str
        """
    ...
    def iot_server2(self):
        """
        Gets the iot_server2 of this IotCardDto.
        第二通道IoT服务器，支持域名和IP地址。

        :return: The iot_server2 of this IotCardDto.
        :rtype: str
        """
    ...
    def iot_server2(self, iot_server2):
        """
        Sets the iot_server2 of this IotCardDto.
        第二通道IoT服务器，支持域名和IP地址。

        :param iot_server2: The iot_server2 of this IotCardDto.
        :type: str
        """
    ...
    def port2(self):
        """
        Gets the port2 of this IotCardDto.
        第二通道IoT端口。

        :return: The port2 of this IotCardDto.
        :rtype: int
        """
        return self._port2
    ...
    def port2(self, port2):
        """
        Sets the port2 of this IotCardDto.
        第二通道IoT端口。

        :param port2: The port2 of this IotCardDto.
        :type: int
        """
    ...
    def administrative_status(self):
        """
        Gets the administrative_status of this IotCardDto.
        使能管理状态。

        :return: The administrative_status of this IotCardDto.
        :rtype: bool
        """
    ...
    def administrative_status(self, administrative_status):
        """
        Sets the administrative_status of this IotCardDto.
        使能管理状态。

        :param administrative_status: The administrative_status of this IotCardDto.
        :type: bool
        """
    ...
    def default_vlan(self):
        """
        Gets the default_vlan of this IotCardDto.
        默认放通VLAN。

        :return: The default_vlan of this IotCardDto.
        :rtype: int
        """
    ...
    def default_vlan(self, default_vlan):
        """
        Sets the default_vlan of this IotCardDto.
        默认放通VLAN。

        :param default_vlan: The default_vlan of this IotCardDto.
        :type: int
        """
    ...
    def description(self):
        """
        Gets the description of this IotCardDto.
        描述，不能输入中文和特殊字符。

        :return: The description of this IotCardDto.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this IotCardDto.
        描述，不能输入中文和特殊字符。

        :param description: The description of this IotCardDto.
        :type: str
        """
    ...
    def iot_server1_config(self):
        """
        Gets the iot_server1_config of this IotCardDto.

        :return: The iot_server1_config of this IotCardDto.
    ...
    def iot_server1_config(self, iot_server1_config):
        """
        Sets the iot_server1_config of this IotCardDto.

        :param iot_server1_config: The iot_server1_config of this IotCardDto.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, IotCardDto):
            return False
