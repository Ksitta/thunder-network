...
class BaseResponseDto(object):
    ...
    def __init__(self, errcode=None, errmsg=None):
        """
        BaseResponseDto - a model defined in Swagger
        """
    ...
    def errcode(self):
        """
        Gets the errcode of this BaseResponseDto.
        错误码，错误码为0表示操作成功。

        :return: The errcode of this BaseResponseDto.
        :rtype: str
        """
    ...
    def errcode(self, errcode):
        """
        Sets the errcode of this BaseResponseDto.
        错误码，错误码为0表示操作成功。

        :param errcode: The errcode of this BaseResponseDto.
        :type: str
        """
    ...
    def errmsg(self):
        """
        Gets the errmsg of this BaseResponseDto.
        错误信息。

        :return: The errmsg of this BaseResponseDto.
        :rtype: str
        """
        return self._errmsg
    ...
    def errmsg(self, errmsg):
        """
        Sets the errmsg of this BaseResponseDto.
        错误信息。

        :param errmsg: The errmsg of this BaseResponseDto.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, BaseResponseDto):
            return False
