...
class RestartPolicyDto(object):
    ...
    def __init__(self, type=None, day=None, daytime=None, time_zone_off_set=None):
        """
        RestartPolicyDto - a model defined in Swagger
        """
    ...
    def type(self):
        """
        Gets the type of this RestartPolicyDto.
        ...
        :return: The type of this RestartPolicyDto.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this RestartPolicyDto.
        重启策略，immediately（立即重启），weektime（周期重启）二者之一。 如果是立即重启场景，type填写immediately； 如果是周期重启场景，type填写|weektime，day，daytime和timeZoneOffSet会生效。 

        :param type: The type of this RestartPolicyDto.
        :type: str
        """
    ...
    def day(self):
        """
        Gets the day of this RestartPolicyDto.
        周几。

        :return: The day of this RestartPolicyDto.
        :rtype: str
        """
        return self._day
    ...
    def day(self, day):
        """
        Sets the day of this RestartPolicyDto.
        周几。

        :param day: The day of this RestartPolicyDto.
        :type: str
        """
    ...
    def daytime(self):
        """
        Gets the daytime of this RestartPolicyDto.
        按周重启，配置重启时间，格式为hh:mm:ss。

        :return: The daytime of this RestartPolicyDto.
        :rtype: str
        """
    ...
    def daytime(self, daytime):
        """
        Sets the daytime of this RestartPolicyDto.
        按周重启，配置重启时间，格式为hh:mm:ss。

        :param daytime: The daytime of this RestartPolicyDto.
        :type: str
        """
    ...
    def time_zone_off_set(self):
        """
        Gets the time_zone_off_set of this RestartPolicyDto.
        时区，UTC+08:00。

        :return: The time_zone_off_set of this RestartPolicyDto.
        :rtype: str
        """
    ...
    def time_zone_off_set(self, time_zone_off_set):
        """
        Sets the time_zone_off_set of this RestartPolicyDto.
        时区，UTC+08:00。

        :param time_zone_off_set: The time_zone_off_set of this RestartPolicyDto.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RestartPolicyDto):
            return False
