...
class CreateRadiusTempDto(object):
    """
    ...
    def __init__(self, name=None, description=None, master_auth_server=None, slave_auth_server=None, master_account_server=None, slave_account_server=None, realtime_accounting=None, prohibit_attribute=None, called_station_id=None, share_key=None):
        """
        CreateRadiusTempDto - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this CreateRadiusTempDto.
        RADIUS模板名称不能包含特殊字符 ~ $ @ # & ? = + % * ( ) { } < > ] [ ^ ! , : ; ` ' / | \\ \"，且不能单独以-或- -作为模板名称。

        :return: The name of this CreateRadiusTempDto.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this CreateRadiusTempDto.
        RADIUS模板名称不能包含特殊字符 ~ $ @ # & ? = + % * ( ) { } < > ] [ ^ ! , : ; ` ' / | \\ \"，且不能单独以-或- -作为模板名称。

        :param name: The name of this CreateRadiusTempDto.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this CreateRadiusTempDto.
        RADIUS模板描述。

        :return: The description of this CreateRadiusTempDto.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this CreateRadiusTempDto.
        RADIUS模板描述。

        :param description: The description of this CreateRadiusTempDto.
        :type: str
        """
    ...
    def master_auth_server(self):
        """
        Gets the master_auth_server of this CreateRadiusTempDto.

        :return: The master_auth_server of this CreateRadiusTempDto.
    ...
    def master_auth_server(self, master_auth_server):
        """
        Sets the master_auth_server of this CreateRadiusTempDto.

        :param master_auth_server: The master_auth_server of this CreateRadiusTempDto.
    ...
    def slave_auth_server(self):
        """
        Gets the slave_auth_server of this CreateRadiusTempDto.

        :return: The slave_auth_server of this CreateRadiusTempDto.
    ...
    def slave_auth_server(self, slave_auth_server):
        """
        Sets the slave_auth_server of this CreateRadiusTempDto.

        :param slave_auth_server: The slave_auth_server of this CreateRadiusTempDto.
    ...
    def master_account_server(self):
        """
        Gets the master_account_server of this CreateRadiusTempDto.

        :return: The master_account_server of this CreateRadiusTempDto.
    ...
    def master_account_server(self, master_account_server):
        """
        Sets the master_account_server of this CreateRadiusTempDto.

        :param master_account_server: The master_account_server of this CreateRadiusTempDto.
    ...
    def slave_account_server(self):
        """
        Gets the slave_account_server of this CreateRadiusTempDto.

        :return: The slave_account_server of this CreateRadiusTempDto.
    ...
    def slave_account_server(self, slave_account_server):
        """
        Sets the slave_account_server of this CreateRadiusTempDto.

        :param slave_account_server: The slave_account_server of this CreateRadiusTempDto.
    ...
    def realtime_accounting(self):
        """
        Gets the realtime_accounting of this CreateRadiusTempDto.

        :return: The realtime_accounting of this CreateRadiusTempDto.
    ...
    def realtime_accounting(self, realtime_accounting):
        """
        Sets the realtime_accounting of this CreateRadiusTempDto.

        :param realtime_accounting: The realtime_accounting of this CreateRadiusTempDto.
    ...
    def prohibit_attribute(self):
        """
        Gets the prohibit_attribute of this CreateRadiusTempDto.

        :return: The prohibit_attribute of this CreateRadiusTempDto.
    ...
    def prohibit_attribute(self, prohibit_attribute):
        """
        Sets the prohibit_attribute of this CreateRadiusTempDto.

        :param prohibit_attribute: The prohibit_attribute of this CreateRadiusTempDto.
    ...
    def called_station_id(self):
        """
        Gets the called_station_id of this CreateRadiusTempDto.

        :return: The called_station_id of this CreateRadiusTempDto.
    ...
    def called_station_id(self, called_station_id):
        """
        Sets the called_station_id of this CreateRadiusTempDto.

        :param called_station_id: The called_station_id of this CreateRadiusTempDto.
    ...
    def share_key(self):
        """
        Gets the share_key of this CreateRadiusTempDto.
        密钥（英文字母、数字、除空格和问号外特殊符号，且不能全为*，建议长度为6位以上）。

        :return: The share_key of this CreateRadiusTempDto.
        :rtype: str
        """
    ...
    def share_key(self, share_key):
        """
        Sets the share_key of this CreateRadiusTempDto.
        密钥（英文字母、数字、除空格和问号外特殊符号，且不能全为*，建议长度为6位以上）。

        :param share_key: The share_key of this CreateRadiusTempDto.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CreateRadiusTempDto):
            return False
