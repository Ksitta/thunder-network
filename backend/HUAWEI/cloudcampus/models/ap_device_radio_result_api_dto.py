...
class ApDeviceRadioResultApiDto(object):
    """
    ...
    def __init__(self, radio2dot4_enabled=None, radio2dot4_power=None, radio2dot4_channel=None, radio2dot4_bandwidth=None, antenna2_dot4_gain=None, radio5_enabled=None, radio5_power=None, radio5_channel=None, antenna5_gain=None, radio5_bandwidth=None, device_id=None, device_name=None):
        """
        ApDeviceRadioResultApiDto - a model defined in Swagger
        """
    ...
    def radio2dot4_enabled(self):
        """
        Gets the radio2dot4_enabled of this ApDeviceRadioResultApiDto.
        2.4G射频使能状态。

        :return: The radio2dot4_enabled of this ApDeviceRadioResultApiDto.
        :rtype: bool
        """
    ...
    def radio2dot4_enabled(self, radio2dot4_enabled):
        """
        Sets the radio2dot4_enabled of this ApDeviceRadioResultApiDto.
        2.4G射频使能状态。

        :param radio2dot4_enabled: The radio2dot4_enabled of this ApDeviceRadioResultApiDto.
        :type: bool
        """
    ...
    def radio2dot4_power(self):
        """
        Gets the radio2dot4_power of this ApDeviceRadioResultApiDto.
        2.4G射频发射功率，auto，[1,127]。

        :return: The radio2dot4_power of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def radio2dot4_power(self, radio2dot4_power):
        """
        Sets the radio2dot4_power of this ApDeviceRadioResultApiDto.
        2.4G射频发射功率，auto，[1,127]。

        :param radio2dot4_power: The radio2dot4_power of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def radio2dot4_channel(self):
        """
        Gets the radio2dot4_channel of this ApDeviceRadioResultApiDto.
        2.4G射频信道，不同国家码，对应不同的射频信道范围。

        :return: The radio2dot4_channel of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def radio2dot4_channel(self, radio2dot4_channel):
        """
        Sets the radio2dot4_channel of this ApDeviceRadioResultApiDto.
        2.4G射频信道，不同国家码，对应不同的射频信道范围。

        :param radio2dot4_channel: The radio2dot4_channel of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def radio2dot4_bandwidth(self):
        """
        Gets the radio2dot4_bandwidth of this ApDeviceRadioResultApiDto.
        2.4G调优频宽，调优带宽时选择auto，此时2.4G信道也应该为auto。

        :return: The radio2dot4_bandwidth of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def radio2dot4_bandwidth(self, radio2dot4_bandwidth):
        """
        Sets the radio2dot4_bandwidth of this ApDeviceRadioResultApiDto.
        2.4G调优频宽，调优带宽时选择auto，此时2.4G信道也应该为auto。

        :param radio2dot4_bandwidth: The radio2dot4_bandwidth of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def antenna2_dot4_gain(self):
        """
        Gets the antenna2_dot4_gain of this ApDeviceRadioResultApiDto.
        2.4G射频天线增益，0~30，室内AP天线增益不支持修改。

        :return: The antenna2_dot4_gain of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def antenna2_dot4_gain(self, antenna2_dot4_gain):
        """
        Sets the antenna2_dot4_gain of this ApDeviceRadioResultApiDto.
        2.4G射频天线增益，0~30，室内AP天线增益不支持修改。

        :param antenna2_dot4_gain: The antenna2_dot4_gain of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def radio5_enabled(self):
        """
        Gets the radio5_enabled of this ApDeviceRadioResultApiDto.
        5G射频使能状态。

        :return: The radio5_enabled of this ApDeviceRadioResultApiDto.
        :rtype: bool
        """
    ...
    def radio5_enabled(self, radio5_enabled):
        """
        Sets the radio5_enabled of this ApDeviceRadioResultApiDto.
        5G射频使能状态。

        :param radio5_enabled: The radio5_enabled of this ApDeviceRadioResultApiDto.
        :type: bool
        """
    ...
    def radio5_power(self):
        """
        Gets the radio5_power of this ApDeviceRadioResultApiDto.
        5G射频发射功率，auto，[1,127]。

        :return: The radio5_power of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def radio5_power(self, radio5_power):
        """
        Sets the radio5_power of this ApDeviceRadioResultApiDto.
        5G射频发射功率，auto，[1,127]。

        :param radio5_power: The radio5_power of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def radio5_channel(self):
        """
        Gets the radio5_channel of this ApDeviceRadioResultApiDto.
        5G射频信道，不同国家码，对应不同的射频信道范围。

        :return: The radio5_channel of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def radio5_channel(self, radio5_channel):
        """
        Sets the radio5_channel of this ApDeviceRadioResultApiDto.
        5G射频信道，不同国家码，对应不同的射频信道范围。

        :param radio5_channel: The radio5_channel of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def antenna5_gain(self):
        """
        Gets the antenna5_gain of this ApDeviceRadioResultApiDto.
        5G射频天线增益，0~30，室内AP天线增益不支持修改。

        :return: The antenna5_gain of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def antenna5_gain(self, antenna5_gain):
        """
        Sets the antenna5_gain of this ApDeviceRadioResultApiDto.
        5G射频天线增益，0~30，室内AP天线增益不支持修改。

        :param antenna5_gain: The antenna5_gain of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def radio5_bandwidth(self):
        """
        Gets the radio5_bandwidth of this ApDeviceRadioResultApiDto.
        5G射频频宽，调优带宽时选择auto，此时5G信道也应该为auto。

        :return: The radio5_bandwidth of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def radio5_bandwidth(self, radio5_bandwidth):
        """
        Sets the radio5_bandwidth of this ApDeviceRadioResultApiDto.
        5G射频频宽，调优带宽时选择auto，此时5G信道也应该为auto。

        :param radio5_bandwidth: The radio5_bandwidth of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def device_id(self):
        """
        Gets the device_id of this ApDeviceRadioResultApiDto.
        设备ID。

        :return: The device_id of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def device_id(self, device_id):
        """
        Sets the device_id of this ApDeviceRadioResultApiDto.
        设备ID。

        :param device_id: The device_id of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def device_name(self):
        """
        Gets the device_name of this ApDeviceRadioResultApiDto.
        设备名称。

        :return: The device_name of this ApDeviceRadioResultApiDto.
        :rtype: str
        """
    ...
    def device_name(self, device_name):
        """
        Sets the device_name of this ApDeviceRadioResultApiDto.
        设备名称。

        :param device_name: The device_name of this ApDeviceRadioResultApiDto.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApDeviceRadioResultApiDto):
            return False
