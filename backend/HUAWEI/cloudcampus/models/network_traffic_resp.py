...
class NetworkTrafficResp(object):
    """
    ...
    def __init__(self, errcode=None, errmsg=None, total_records=None, data=None):
        """
        NetworkTrafficResp - a model defined in Swagger
        """
    ...
    def errcode(self):
        """
        Gets the errcode of this NetworkTrafficResp.
        错误码信息。

        :return: The errcode of this NetworkTrafficResp.
        :rtype: str
        """
    ...
    def errcode(self, errcode):
        """
        Sets the errcode of this NetworkTrafficResp.
        错误码信息。

        :param errcode: The errcode of this NetworkTrafficResp.
        :type: str
        """
    ...
    def errmsg(self):
        """
        Gets the errmsg of this NetworkTrafficResp.
        结果信息。

        :return: The errmsg of this NetworkTrafficResp.
        :rtype: str
        """
        return self._errmsg
    ...
    def errmsg(self, errmsg):
        """
        Sets the errmsg of this NetworkTrafficResp.
        结果信息。

        :param errmsg: The errmsg of this NetworkTrafficResp.
        :type: str
        """
    ...
    def total_records(self):
        """
        Gets the total_records of this NetworkTrafficResp.
        查询到的总条数。

        :return: The total_records of this NetworkTrafficResp.
        :rtype: int
        """
    ...
    def total_records(self, total_records):
        """
        Sets the total_records of this NetworkTrafficResp.
        查询到的总条数。

        :param total_records: The total_records of this NetworkTrafficResp.
        :type: int
        """
    ...
    def data(self):
        """
        Gets the data of this NetworkTrafficResp.
        查询到的网络速率信息。

        :return: The data of this NetworkTrafficResp.
    ...
    def data(self, data):
        """
        Sets the data of this NetworkTrafficResp.
        查询到的网络速率信息。

        :param data: The data of this NetworkTrafficResp.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NetworkTrafficResp):
            return False
