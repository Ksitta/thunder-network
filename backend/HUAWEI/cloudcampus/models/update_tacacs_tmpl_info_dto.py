...
class UpdateTacacsTmplInfoDto(object):
    """
    ...
    def __init__(self, name=None, description=None, master_authen_server_ip=None, master_authen_server_port=None, slave_authen_server_ip=None, slave_authen_server_port=None, master_author_server_ip=None, master_author_server_port=None, slave_author_server_ip=None, slave_author_server_port=None, master_acc_server_ip=None, master_acc_server_port=None, slave_acc_server_ip=None, slave_acc_server_port=None, include_domain=None, share_key=None):
        """
        UpdateTacacsTmplInfoDto - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this UpdateTacacsTmplInfoDto.
        名称（不支持$&?=+%][^_,#\"相关特殊字符）。

        :return: The name of this UpdateTacacsTmplInfoDto.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this UpdateTacacsTmplInfoDto.
        名称（不支持$&?=+%][^_,#\"相关特殊字符）。

        :param name: The name of this UpdateTacacsTmplInfoDto.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this UpdateTacacsTmplInfoDto.
        描述。

        :return: The description of this UpdateTacacsTmplInfoDto.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this UpdateTacacsTmplInfoDto.
        描述。

        :param description: The description of this UpdateTacacsTmplInfoDto.
        :type: str
        """
    ...
    def master_authen_server_ip(self):
        """
        Gets the master_authen_server_ip of this UpdateTacacsTmplInfoDto.
        主认证服务器IP地址。

        :return: The master_authen_server_ip of this UpdateTacacsTmplInfoDto.
        :rtype: str
        """
    ...
    def master_authen_server_ip(self, master_authen_server_ip):
        """
        Sets the master_authen_server_ip of this UpdateTacacsTmplInfoDto.
        主认证服务器IP地址。

        :param master_authen_server_ip: The master_authen_server_ip of this UpdateTacacsTmplInfoDto.
        :type: str
        """
    ...
    def master_authen_server_port(self):
        """
        Gets the master_authen_server_port of this UpdateTacacsTmplInfoDto.
        主认证服务器端口。

        :return: The master_authen_server_port of this UpdateTacacsTmplInfoDto.
        :rtype: int
        """
    ...
    def master_authen_server_port(self, master_authen_server_port):
        """
        Sets the master_authen_server_port of this UpdateTacacsTmplInfoDto.
        主认证服务器端口。

        :param master_authen_server_port: The master_authen_server_port of this UpdateTacacsTmplInfoDto.
        :type: int
        """
    ...
    def slave_authen_server_ip(self):
        """
        Gets the slave_authen_server_ip of this UpdateTacacsTmplInfoDto.
        备认证服务器IP地址。

        :return: The slave_authen_server_ip of this UpdateTacacsTmplInfoDto.
        :rtype: str
        """
    ...
    def slave_authen_server_ip(self, slave_authen_server_ip):
        """
        Sets the slave_authen_server_ip of this UpdateTacacsTmplInfoDto.
        备认证服务器IP地址。

        :param slave_authen_server_ip: The slave_authen_server_ip of this UpdateTacacsTmplInfoDto.
        :type: str
        """
    ...
    def slave_authen_server_port(self):
        """
        Gets the slave_authen_server_port of this UpdateTacacsTmplInfoDto.
        备认证服务器端口。

        :return: The slave_authen_server_port of this UpdateTacacsTmplInfoDto.
        :rtype: int
        """
    ...
    def slave_authen_server_port(self, slave_authen_server_port):
        """
        Sets the slave_authen_server_port of this UpdateTacacsTmplInfoDto.
        备认证服务器端口。

        :param slave_authen_server_port: The slave_authen_server_port of this UpdateTacacsTmplInfoDto.
        :type: int
        """
    ...
    def master_author_server_ip(self):
        """
        Gets the master_author_server_ip of this UpdateTacacsTmplInfoDto.
        主授权服务器IP地址。

        :return: The master_author_server_ip of this UpdateTacacsTmplInfoDto.
        :rtype: str
        """
    ...
    def master_author_server_ip(self, master_author_server_ip):
        """
        Sets the master_author_server_ip of this UpdateTacacsTmplInfoDto.
        主授权服务器IP地址。

        :param master_author_server_ip: The master_author_server_ip of this UpdateTacacsTmplInfoDto.
        :type: str
        """
    ...
    def master_author_server_port(self):
        """
        Gets the master_author_server_port of this UpdateTacacsTmplInfoDto.
        主授权服务器端口。

        :return: The master_author_server_port of this UpdateTacacsTmplInfoDto.
        :rtype: int
        """
    ...
    def master_author_server_port(self, master_author_server_port):
        """
        Sets the master_author_server_port of this UpdateTacacsTmplInfoDto.
        主授权服务器端口。

        :param master_author_server_port: The master_author_server_port of this UpdateTacacsTmplInfoDto.
        :type: int
        """
    ...
    def slave_author_server_ip(self):
        """
        Gets the slave_author_server_ip of this UpdateTacacsTmplInfoDto.
        备授权服务器IP地址。

        :return: The slave_author_server_ip of this UpdateTacacsTmplInfoDto.
        :rtype: str
        """
    ...
    def slave_author_server_ip(self, slave_author_server_ip):
        """
        Sets the slave_author_server_ip of this UpdateTacacsTmplInfoDto.
        备授权服务器IP地址。

        :param slave_author_server_ip: The slave_author_server_ip of this UpdateTacacsTmplInfoDto.
        :type: str
        """
    ...
    def slave_author_server_port(self):
        """
        Gets the slave_author_server_port of this UpdateTacacsTmplInfoDto.
        备授权服务器端口。

        :return: The slave_author_server_port of this UpdateTacacsTmplInfoDto.
        :rtype: int
        """
    ...
    def slave_author_server_port(self, slave_author_server_port):
        """
        Sets the slave_author_server_port of this UpdateTacacsTmplInfoDto.
        备授权服务器端口。

        :param slave_author_server_port: The slave_author_server_port of this UpdateTacacsTmplInfoDto.
        :type: int
        """
    ...
    def master_acc_server_ip(self):
        """
        Gets the master_acc_server_ip of this UpdateTacacsTmplInfoDto.
        主计费服务器IP地址。

        :return: The master_acc_server_ip of this UpdateTacacsTmplInfoDto.
        :rtype: str
        """
    ...
    def master_acc_server_ip(self, master_acc_server_ip):
        """
        Sets the master_acc_server_ip of this UpdateTacacsTmplInfoDto.
        主计费服务器IP地址。

        :param master_acc_server_ip: The master_acc_server_ip of this UpdateTacacsTmplInfoDto.
        :type: str
        """
    ...
    def master_acc_server_port(self):
        """
        Gets the master_acc_server_port of this UpdateTacacsTmplInfoDto.
        主计费服务器端口。

        :return: The master_acc_server_port of this UpdateTacacsTmplInfoDto.
        :rtype: int
        """
    ...
    def master_acc_server_port(self, master_acc_server_port):
        """
        Sets the master_acc_server_port of this UpdateTacacsTmplInfoDto.
        主计费服务器端口。

        :param master_acc_server_port: The master_acc_server_port of this UpdateTacacsTmplInfoDto.
        :type: int
        """
    ...
    def slave_acc_server_ip(self):
        """
        Gets the slave_acc_server_ip of this UpdateTacacsTmplInfoDto.
        备计费服务器IP地址。

        :return: The slave_acc_server_ip of this UpdateTacacsTmplInfoDto.
        :rtype: str
        """
    ...
    def slave_acc_server_ip(self, slave_acc_server_ip):
        """
        Sets the slave_acc_server_ip of this UpdateTacacsTmplInfoDto.
        备计费服务器IP地址。

        :param slave_acc_server_ip: The slave_acc_server_ip of this UpdateTacacsTmplInfoDto.
        :type: str
        """
    ...
    def slave_acc_server_port(self):
        """
        Gets the slave_acc_server_port of this UpdateTacacsTmplInfoDto.
        备计费服务器端口。

        :return: The slave_acc_server_port of this UpdateTacacsTmplInfoDto.
        :rtype: int
        """
    ...
    def slave_acc_server_port(self, slave_acc_server_port):
        """
        Sets the slave_acc_server_port of this UpdateTacacsTmplInfoDto.
        备计费服务器端口。

        :param slave_acc_server_port: The slave_acc_server_port of this UpdateTacacsTmplInfoDto.
        :type: int
        """
    ...
    def include_domain(self):
        """
        Gets the include_domain of this UpdateTacacsTmplInfoDto.
        向Tacacs服务器发起认证的用户名是否包含域名。

        :return: The include_domain of this UpdateTacacsTmplInfoDto.
        :rtype: bool
        """
    ...
    def include_domain(self, include_domain):
        """
        Sets the include_domain of this UpdateTacacsTmplInfoDto.
        向Tacacs服务器发起认证的用户名是否包含域名。

        :param include_domain: The include_domain of this UpdateTacacsTmplInfoDto.
        :type: bool
        """
    ...
    def share_key(self):
        """
        Gets the share_key of this UpdateTacacsTmplInfoDto.
        秘钥（英文字母、数字、除空格和问号外特殊符号，建议长度为6位以上）。

        :return: The share_key of this UpdateTacacsTmplInfoDto.
        :rtype: str
        """
    ...
    def share_key(self, share_key):
        """
        Sets the share_key of this UpdateTacacsTmplInfoDto.
        秘钥（英文字母、数字、除空格和问号外特殊符号，建议长度为6位以上）。

        :param share_key: The share_key of this UpdateTacacsTmplInfoDto.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UpdateTacacsTmplInfoDto):
            return False
