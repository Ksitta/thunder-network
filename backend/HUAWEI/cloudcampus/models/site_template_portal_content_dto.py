...
class SiteTemplatePortalContentDto(object):
    """
    ...
    def __init__(self, mode=None, free_auth_enable=None, auth_expire_unit=None, auth_expire=None, escape_strategy=None, free_acl_tmpl_id=None, free_acl_tmpl_name=None):
        """
        SiteTemplatePortalContentDto - a model defined in Swagger
        """
    ...
    def mode(self):
        """
        Gets the mode of this SiteTemplatePortalContentDto.
        认证方式。 portalDisable---不启用Portal认证。 portalThirdIndirect---云平台中继认证（对接方式：API）。

        :return: The mode of this SiteTemplatePortalContentDto.
        :rtype: str
        """
        return self._mode
    ...
    def mode(self, mode):
        """
        Sets the mode of this SiteTemplatePortalContentDto.
        认证方式。 portalDisable---不启用Portal认证。 portalThirdIndirect---云平台中继认证（对接方式：API）。

        :param mode: The mode of this SiteTemplatePortalContentDto.
        :type: str
        """
    ...
    def free_auth_enable(self):
        """
        Gets the free_auth_enable of this SiteTemplatePortalContentDto.
        有效期内免认证是否开启，当mode为portalThirdIndirect时必选。

        :return: The free_auth_enable of this SiteTemplatePortalContentDto.
        :rtype: bool
        """
    ...
    def free_auth_enable(self, free_auth_enable):
        """
        Sets the free_auth_enable of this SiteTemplatePortalContentDto.
        有效期内免认证是否开启，当mode为portalThirdIndirect时必选。

        :param free_auth_enable: The free_auth_enable of this SiteTemplatePortalContentDto.
        :type: bool
        """
    ...
    def auth_expire_unit(self):
        """
        Gets the auth_expire_unit of this SiteTemplatePortalContentDto.
        ...
        :return: The auth_expire_unit of this SiteTemplatePortalContentDto.
        :rtype: str
        """
    ...
    def auth_expire_unit(self, auth_expire_unit):
        """
        Sets the auth_expire_unit of this SiteTemplatePortalContentDto.
        Portal认证有效期单位，ssid创建场景：freeAuthEnable为true时，此字段不传则默认值为minute；ssid更新场景：freeAuthEnable为true时，此字段不传则使用更新前的值。只能为day、hour、minute中的一个，大小写不敏感，前后空格忽略，且不能含有全角字符。

        :param auth_expire_unit: The auth_expire_unit of this SiteTemplatePortalContentDto.
        :type: str
        """
    ...
    def auth_expire(self):
        """
        Gets the auth_expire of this SiteTemplatePortalContentDto.
        ...
        :return: The auth_expire of this SiteTemplatePortalContentDto.
        :rtype: int
        """
    ...
    def auth_expire(self, auth_expire):
        """
        Sets the auth_expire of this SiteTemplatePortalContentDto.
        Portal认证有效期，ssid创建场景：freeAuthEnable为true时，此字段不传则默认值为2；ssid更新场景：freeAuthEnable为true时，此字段不传则使用更新前的值。 authExpireUnit为minute时，范围为1~59。 authExpireUnit为hour时，范围为1~23。 authExpireUnit为day时，范围为1~365。

        :param auth_expire: The auth_expire of this SiteTemplatePortalContentDto.
        :type: int
        """
    ...
    def escape_strategy(self):
        """
        Gets the escape_strategy of this SiteTemplatePortalContentDto.
        逃生策略，当mode为portalThirdIndirect时有效。 1---允许已认证用户继续使用网络，新用户不允许接入，默认值 2---允许用户接入，不需要认证

        :return: The escape_strategy of this SiteTemplatePortalContentDto.
        :rtype: int
        """
    ...
    def escape_strategy(self, escape_strategy):
        """
        Sets the escape_strategy of this SiteTemplatePortalContentDto.
        逃生策略，当mode为portalThirdIndirect时有效。 1---允许已认证用户继续使用网络，新用户不允许接入，默认值 2---允许用户接入，不需要认证

        :param escape_strategy: The escape_strategy of this SiteTemplatePortalContentDto.
        :type: int
        """
    ...
    def free_acl_tmpl_id(self):
        """
        Gets the free_acl_tmpl_id of this SiteTemplatePortalContentDto.
        免认证ACL，当mode为portalThirdIndirect时必填。免认证ACL可以通过第三方开放接口/controller/campus/v3/profile/acl得到。UUID格式。

        :return: The free_acl_tmpl_id of this SiteTemplatePortalContentDto.
        :rtype: str
        """
    ...
    def free_acl_tmpl_id(self, free_acl_tmpl_id):
        """
        Sets the free_acl_tmpl_id of this SiteTemplatePortalContentDto.
        免认证ACL，当mode为portalThirdIndirect时必填。免认证ACL可以通过第三方开放接口/controller/campus/v3/profile/acl得到。UUID格式。

        :param free_acl_tmpl_id: The free_acl_tmpl_id of this SiteTemplatePortalContentDto.
        :type: str
        """
    ...
    def free_acl_tmpl_name(self):
        """
        Gets the free_acl_tmpl_name of this SiteTemplatePortalContentDto.
        免认证ACL名称，当mode为portalThirdIndirect时有效。POST与PUT操作时，该字段无效。长度为1至32字节。

        :return: The free_acl_tmpl_name of this SiteTemplatePortalContentDto.
        :rtype: str
        """
    ...
    def free_acl_tmpl_name(self, free_acl_tmpl_name):
        """
        Sets the free_acl_tmpl_name of this SiteTemplatePortalContentDto.
        免认证ACL名称，当mode为portalThirdIndirect时有效。POST与PUT操作时，该字段无效。长度为1至32字节。

        :param free_acl_tmpl_name: The free_acl_tmpl_name of this SiteTemplatePortalContentDto.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SiteTemplatePortalContentDto):
            return False
