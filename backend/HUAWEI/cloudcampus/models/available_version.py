...
class AvailableVersion(object):
    ...
    def __init__(self, errcode=None, errmsg=None, data=None):
        """
        AvailableVersion - a model defined in Swagger
        """
    ...
    def errcode(self):
        """
        Gets the errcode of this AvailableVersion.
        错误码。

        :return: The errcode of this AvailableVersion.
        :rtype: str
        """
    ...
    def errcode(self, errcode):
        """
        Sets the errcode of this AvailableVersion.
        错误码。

        :param errcode: The errcode of this AvailableVersion.
        :type: str
        """
    ...
    def errmsg(self):
        """
        Gets the errmsg of this AvailableVersion.
        错误信息。

        :return: The errmsg of this AvailableVersion.
        :rtype: str
        """
        return self._errmsg
    ...
    def errmsg(self, errmsg):
        """
        Sets the errmsg of this AvailableVersion.
        错误信息。

        :param errmsg: The errmsg of this AvailableVersion.
        :type: str
        """
    ...
    def data(self):
        """
        Gets the data of this AvailableVersion.

        :return: The data of this AvailableVersion.
        :rtype: Pkg
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this AvailableVersion.

        :param data: The data of this AvailableVersion.
        :type: Pkg
        """
