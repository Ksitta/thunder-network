...
class FwRouteInfo(object):
    ...
    def __init__(self, mask=None, destination_prefix_ip=None, next_hop_address=None, next_interface=None, track_iplink_id=None, preference=None):
        """
        FwRouteInfo - a model defined in Swagger
        """
    ...
    def mask(self):
        """
        Gets the mask of this FwRouteInfo.
        掩码。

        :return: The mask of this FwRouteInfo.
        :rtype: int
        """
        return self._mask
    ...
    def mask(self, mask):
        """
        Sets the mask of this FwRouteInfo.
        掩码。

        :param mask: The mask of this FwRouteInfo.
        :type: int
        """
    ...
    def destination_prefix_ip(self):
        """
        Gets the destination_prefix_ip of this FwRouteInfo.
        目的地址，必须是合法的IPv4地址，以127或者224~255开头的IP地址为非法IP地址。

        :return: The destination_prefix_ip of this FwRouteInfo.
        :rtype: str
        """
    ...
    def destination_prefix_ip(self, destination_prefix_ip):
        """
        Sets the destination_prefix_ip of this FwRouteInfo.
        目的地址，必须是合法的IPv4地址，以127或者224~255开头的IP地址为非法IP地址。

        :param destination_prefix_ip: The destination_prefix_ip of this FwRouteInfo.
        :type: str
        """
    ...
    def next_hop_address(self):
        """
        Gets the next_hop_address of this FwRouteInfo.
        下一跳地址，必须是合法的IPv4地址，以127或者224~255开头的IP地址为非法IP地址。当nextInterface为空时，nextHopAddress必填。

        :return: The next_hop_address of this FwRouteInfo.
        :rtype: str
        """
    ...
    def next_hop_address(self, next_hop_address):
        """
        Sets the next_hop_address of this FwRouteInfo.
        下一跳地址，必须是合法的IPv4地址，以127或者224~255开头的IP地址为非法IP地址。当nextInterface为空时，nextHopAddress必填。

        :param next_hop_address: The next_hop_address of this FwRouteInfo.
        :type: str
        """
    ...
    def next_interface(self):
        """
        Gets the next_interface of this FwRouteInfo.
        设备出接口。当nextHopAddress为空时，nextInterface必填。

        :return: The next_interface of this FwRouteInfo.
        :rtype: str
        """
    ...
    def next_interface(self, next_interface):
        """
        Sets the next_interface of this FwRouteInfo.
        设备出接口。当nextHopAddress为空时，nextInterface必填。

        :param next_interface: The next_interface of this FwRouteInfo.
        :type: str
        """
    ...
    def track_iplink_id(self):
        """
        Gets the track_iplink_id of this FwRouteInfo.
        IP链接ID。

        :return: The track_iplink_id of this FwRouteInfo.
        :rtype: str
        """
    ...
    def track_iplink_id(self, track_iplink_id):
        """
        Sets the track_iplink_id of this FwRouteInfo.
        IP链接ID。

        :param track_iplink_id: The track_iplink_id of this FwRouteInfo.
        :type: str
        """
    ...
    def preference(self):
        """
        Gets the preference of this FwRouteInfo.
        优先级。取值越小，优先等级越高。

        :return: The preference of this FwRouteInfo.
        :rtype: int
        """
    ...
    def preference(self, preference):
        """
        Sets the preference of this FwRouteInfo.
        优先级。取值越小，优先等级越高。

        :param preference: The preference of this FwRouteInfo.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, FwRouteInfo):
            return False
