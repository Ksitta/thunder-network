...
class LSWPortDto(object):
    ...
    def __init__(self, status=None, description=None, link_type=None, default_vlan=None, allow_pass_vlan=None, dhcp_snooping=None, dhcp_snooping_trusted=None, nd_snooping=None, nd_snooping_trusted=None, port_isolation=None, stp=None, stp_edgedport=None, enable_relay=None, enable_mad_detection=None, domain_id=None, na_msg_check=None, ns_msg_check=None, rs_msg_check=None, ipsg_check=None, dai_check=None, ip_subnet_vlan_enable=None):
        """
        LSWPortDto - a model defined in Swagger
        """
    ...
    def status(self):
        """
        Gets the status of this LSWPortDto.
        接口管理状态（true为undo shutdown，false为shutdown）。

        :return: The status of this LSWPortDto.
        :rtype: bool
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this LSWPortDto.
        接口管理状态（true为undo shutdown，false为shutdown）。

        :param status: The status of this LSWPortDto.
        :type: bool
        """
    ...
    def description(self):
        """
        Gets the description of this LSWPortDto.
        接口描述。

        :return: The description of this LSWPortDto.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this LSWPortDto.
        接口描述。

        :param description: The description of this LSWPortDto.
        :type: str
        """
    ...
    def link_type(self):
        """
        Gets the link_type of this LSWPortDto.
        链路类型，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。取值：access；trunk。

        :return: The link_type of this LSWPortDto.
        :rtype: str
        """
    ...
    def link_type(self, link_type):
        """
        Sets the link_type of this LSWPortDto.
        链路类型，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。取值：access；trunk。

        :param link_type: The link_type of this LSWPortDto.
        :type: str
        """
    ...
    def default_vlan(self):
        """
        Gets the default_vlan of this LSWPortDto.
        access类型下缺省VLAN；或trunk类型下pvid。若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :return: The default_vlan of this LSWPortDto.
        :rtype: int
        """
    ...
    def default_vlan(self, default_vlan):
        """
        Sets the default_vlan of this LSWPortDto.
        access类型下缺省VLAN；或trunk类型下pvid。若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :param default_vlan: The default_vlan of this LSWPortDto.
        :type: int
        """
    ...
    def allow_pass_vlan(self):
        """
        Gets the allow_pass_vlan of this LSWPortDto.
        trunk类型下允许通过VLAN，接口为trunk类型时必填。

        :return: The allow_pass_vlan of this LSWPortDto.
        :rtype: str
        """
    ...
    def allow_pass_vlan(self, allow_pass_vlan):
        """
        Sets the allow_pass_vlan of this LSWPortDto.
        trunk类型下允许通过VLAN，接口为trunk类型时必填。

        :param allow_pass_vlan: The allow_pass_vlan of this LSWPortDto.
        :type: str
        """
    ...
    def dhcp_snooping(self):
        """
        Gets the dhcp_snooping of this LSWPortDto.
        DHCP Snooping使能，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :return: The dhcp_snooping of this LSWPortDto.
        :rtype: bool
        """
    ...
    def dhcp_snooping(self, dhcp_snooping):
        """
        Sets the dhcp_snooping of this LSWPortDto.
        DHCP Snooping使能，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :param dhcp_snooping: The dhcp_snooping of this LSWPortDto.
        :type: bool
        """
    ...
    def dhcp_snooping_trusted(self):
        """
        Gets the dhcp_snooping_trusted of this LSWPortDto.
        配置接口为DHCP Snooping信任状态，默认为非信任状态。

        :return: The dhcp_snooping_trusted of this LSWPortDto.
        :rtype: bool
        """
    ...
    def dhcp_snooping_trusted(self, dhcp_snooping_trusted):
        """
        Sets the dhcp_snooping_trusted of this LSWPortDto.
        配置接口为DHCP Snooping信任状态，默认为非信任状态。

        :param dhcp_snooping_trusted: The dhcp_snooping_trusted of this LSWPortDto.
        :type: bool
        """
    ...
    def nd_snooping(self):
        """
        Gets the nd_snooping of this LSWPortDto.
        ND Snooping使能，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :return: The nd_snooping of this LSWPortDto.
        :rtype: bool
        """
    ...
    def nd_snooping(self, nd_snooping):
        """
        Sets the nd_snooping of this LSWPortDto.
        ND Snooping使能，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :param nd_snooping: The nd_snooping of this LSWPortDto.
        :type: bool
        """
    ...
    def nd_snooping_trusted(self):
        """
        Gets the nd_snooping_trusted of this LSWPortDto.
        配置接口为ND Snooping信任状态，默认为非信任状态。

        :return: The nd_snooping_trusted of this LSWPortDto.
        :rtype: bool
        """
    ...
    def nd_snooping_trusted(self, nd_snooping_trusted):
        """
        Sets the nd_snooping_trusted of this LSWPortDto.
        配置接口为ND Snooping信任状态，默认为非信任状态。

        :param nd_snooping_trusted: The nd_snooping_trusted of this LSWPortDto.
        :type: bool
        """
    ...
    def port_isolation(self):
        """
        Gets the port_isolation of this LSWPortDto.
        端口隔离使能，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :return: The port_isolation of this LSWPortDto.
        :rtype: bool
        """
    ...
    def port_isolation(self, port_isolation):
        """
        Sets the port_isolation of this LSWPortDto.
        端口隔离使能，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :param port_isolation: The port_isolation of this LSWPortDto.
        :type: bool
        """
    ...
    def stp(self, stp):
        """
        Sets the stp of this LSWPortDto.
        STP功能状态，取值：true（使能）；false（未使能）。当STP为false时，stpEdgedport自动赋值为normal，传入其他参数无效。

        :param stp: The stp of this LSWPortDto.
        :type: bool
        """
    ...
    def stp_edgedport(self):
        """
        Gets the stp_edgedport of this LSWPortDto.
        STP边缘端口状态，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。取值：enable（使能）；normal（遵从全局状态）；disable（未使能）。

        :return: The stp_edgedport of this LSWPortDto.
        :rtype: str
        """
    ...
    def stp_edgedport(self, stp_edgedport):
        """
        Sets the stp_edgedport of this LSWPortDto.
        STP边缘端口状态，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。取值：enable（使能）；normal（遵从全局状态）；disable（未使能）。

        :param stp_edgedport: The stp_edgedport of this LSWPortDto.
        :type: str
        """
    ...
    def enable_relay(self):
        """
        Gets the enable_relay of this LSWPortDto.
        堆叠多主检测场景下，设为检测代理设备。

        :return: The enable_relay of this LSWPortDto.
        :rtype: bool
        """
    ...
    def enable_relay(self, enable_relay):
        """
        Sets the enable_relay of this LSWPortDto.
        堆叠多主检测场景下，设为检测代理设备。

        :param enable_relay: The enable_relay of this LSWPortDto.
        :type: bool
        """
    ...
    def enable_mad_detection(self):
        """
        Gets the enable_mad_detection of this LSWPortDto.
        堆叠多主检测场景下，代理模式双主检测开关。

        :return: The enable_mad_detection of this LSWPortDto.
        :rtype: bool
        """
    ...
    def enable_mad_detection(self, enable_mad_detection):
        """
        Sets the enable_mad_detection of this LSWPortDto.
        堆叠多主检测场景下，代理模式双主检测开关。

        :param enable_mad_detection: The enable_mad_detection of this LSWPortDto.
        :type: bool
        """
    ...
    def domain_id(self):
        """
        Gets the domain_id of this LSWPortDto.
        堆叠多主检测场景下，堆叠域编号，两个堆叠互相检测时，堆叠域编号需不同。

        :return: The domain_id of this LSWPortDto.
        :rtype: int
        """
    ...
    def domain_id(self, domain_id):
        """
        Sets the domain_id of this LSWPortDto.
        堆叠多主检测场景下，堆叠域编号，两个堆叠互相检测时，堆叠域编号需不同。

        :param domain_id: The domain_id of this LSWPortDto.
        :type: int
        """
    ...
    def na_msg_check(self):
        """
        Gets the na_msg_check of this LSWPortDto.
        NA报文检测，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :return: The na_msg_check of this LSWPortDto.
        :rtype: bool
        """
    ...
    def na_msg_check(self, na_msg_check):
        """
        Sets the na_msg_check of this LSWPortDto.
        NA报文检测，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :param na_msg_check: The na_msg_check of this LSWPortDto.
        :type: bool
        """
    ...
    def ns_msg_check(self):
        """
        Gets the ns_msg_check of this LSWPortDto.
        NS报文检测，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :return: The ns_msg_check of this LSWPortDto.
        :rtype: bool
        """
    ...
    def ns_msg_check(self, ns_msg_check):
        """
        Sets the ns_msg_check of this LSWPortDto.
        NS报文检测，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :param ns_msg_check: The ns_msg_check of this LSWPortDto.
        :type: bool
        """
    ...
    def rs_msg_check(self):
        """
        Gets the rs_msg_check of this LSWPortDto.
        RS报文检测，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :return: The rs_msg_check of this LSWPortDto.
        :rtype: bool
        """
    ...
    def rs_msg_check(self, rs_msg_check):
        """
        Sets the rs_msg_check of this LSWPortDto.
        RS报文检测，若当前是以太接口，其加入Eth-Trunk后不能配置此参数。

        :param rs_msg_check: The rs_msg_check of this LSWPortDto.
        :type: bool
        """
    ...
    def ipsg_check(self):
        """
        Gets the ipsg_check of this LSWPortDto.
        IPSG检测使能开关。

        :return: The ipsg_check of this LSWPortDto.
        :rtype: bool
        """
    ...
    def ipsg_check(self, ipsg_check):
        """
        Sets the ipsg_check of this LSWPortDto.
        IPSG检测使能开关。

        :param ipsg_check: The ipsg_check of this LSWPortDto.
        :type: bool
        """
    ...
    def dai_check(self):
        """
        Gets the dai_check of this LSWPortDto.
        DAI检测使能开关。

        :return: The dai_check of this LSWPortDto.
        :rtype: bool
        """
    ...
    def dai_check(self, dai_check):
        """
        Sets the dai_check of this LSWPortDto.
        DAI检测使能开关。

        :param dai_check: The dai_check of this LSWPortDto.
        :type: bool
        """
    ...
    def ip_subnet_vlan_enable(self):
        """
        Gets the ip_subnet_vlan_enable of this LSWPortDto.
        IP子网划分Vlan开关。

        :return: The ip_subnet_vlan_enable of this LSWPortDto.
        :rtype: bool
        """
    ...
    def ip_subnet_vlan_enable(self, ip_subnet_vlan_enable):
        """
        Sets the ip_subnet_vlan_enable of this LSWPortDto.
        IP子网划分Vlan开关。

        :param ip_subnet_vlan_enable: The ip_subnet_vlan_enable of this LSWPortDto.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, LSWPortDto):
            return False
