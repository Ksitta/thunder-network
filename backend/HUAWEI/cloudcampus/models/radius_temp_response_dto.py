...
class RadiusTempResponseDto(object):
    """
    ...
    def __init__(self, name=None, description=None, master_auth_server=None, slave_auth_server=None, master_account_server=None, slave_account_server=None, realtime_accounting=None, prohibit_attribute=None, called_station_id=None, id=None):
        """
        RadiusTempResponseDto - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this RadiusTempResponseDto.
        RADIUS模板名称不能包含特殊字符 ~ $ @ # & ? = + % * ( ) { } < > ] [ ^ ! , : ; ` ' / | \\ \"，且不能单独以-或- -作为模板名称。

        :return: The name of this RadiusTempResponseDto.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this RadiusTempResponseDto.
        RADIUS模板名称不能包含特殊字符 ~ $ @ # & ? = + % * ( ) { } < > ] [ ^ ! , : ; ` ' / | \\ \"，且不能单独以-或- -作为模板名称。

        :param name: The name of this RadiusTempResponseDto.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this RadiusTempResponseDto.
        RADIUS模板描述。

        :return: The description of this RadiusTempResponseDto.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this RadiusTempResponseDto.
        RADIUS模板描述。

        :param description: The description of this RadiusTempResponseDto.
        :type: str
        """
    ...
    def master_auth_server(self):
        """
        Gets the master_auth_server of this RadiusTempResponseDto.

        :return: The master_auth_server of this RadiusTempResponseDto.
    ...
    def master_auth_server(self, master_auth_server):
        """
        Sets the master_auth_server of this RadiusTempResponseDto.

        :param master_auth_server: The master_auth_server of this RadiusTempResponseDto.
    ...
    def slave_auth_server(self):
        """
        Gets the slave_auth_server of this RadiusTempResponseDto.

        :return: The slave_auth_server of this RadiusTempResponseDto.
    ...
    def slave_auth_server(self, slave_auth_server):
        """
        Sets the slave_auth_server of this RadiusTempResponseDto.

        :param slave_auth_server: The slave_auth_server of this RadiusTempResponseDto.
    ...
    def master_account_server(self):
        """
        Gets the master_account_server of this RadiusTempResponseDto.

        :return: The master_account_server of this RadiusTempResponseDto.
    ...
    def master_account_server(self, master_account_server):
        """
        Sets the master_account_server of this RadiusTempResponseDto.

        :param master_account_server: The master_account_server of this RadiusTempResponseDto.
    ...
    def slave_account_server(self):
        """
        Gets the slave_account_server of this RadiusTempResponseDto.

        :return: The slave_account_server of this RadiusTempResponseDto.
    ...
    def slave_account_server(self, slave_account_server):
        """
        Sets the slave_account_server of this RadiusTempResponseDto.

        :param slave_account_server: The slave_account_server of this RadiusTempResponseDto.
    ...
    def realtime_accounting(self):
        """
        Gets the realtime_accounting of this RadiusTempResponseDto.

        :return: The realtime_accounting of this RadiusTempResponseDto.
    ...
    def realtime_accounting(self, realtime_accounting):
        """
        Sets the realtime_accounting of this RadiusTempResponseDto.

        :param realtime_accounting: The realtime_accounting of this RadiusTempResponseDto.
    ...
    def prohibit_attribute(self):
        """
        Gets the prohibit_attribute of this RadiusTempResponseDto.

        :return: The prohibit_attribute of this RadiusTempResponseDto.
    ...
    def prohibit_attribute(self, prohibit_attribute):
        """
        Sets the prohibit_attribute of this RadiusTempResponseDto.

        :param prohibit_attribute: The prohibit_attribute of this RadiusTempResponseDto.
    ...
    def called_station_id(self):
        """
        Gets the called_station_id of this RadiusTempResponseDto.

        :return: The called_station_id of this RadiusTempResponseDto.
    ...
    def called_station_id(self, called_station_id):
        """
        Sets the called_station_id of this RadiusTempResponseDto.

        :param called_station_id: The called_station_id of this RadiusTempResponseDto.
    ...
    def id(self):
        """
        Gets the id of this RadiusTempResponseDto.
        RADIUS模板ID，UUID格式。

        :return: The id of this RadiusTempResponseDto.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this RadiusTempResponseDto.
        RADIUS模板ID，UUID格式。

        :param id: The id of this RadiusTempResponseDto.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RadiusTempResponseDto):
            return False
