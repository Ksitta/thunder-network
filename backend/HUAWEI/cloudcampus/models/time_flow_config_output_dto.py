...
class TimeFlowConfigOutputDto(object):
    """
    ...
    def __init__(self, time_flow_name=None, site_id=None, enable_traffic_limit_mode=None, traffic_limit_mode=None, traffic_limit=None, enable_duration_limit_mode=None, duration_limit_mode=None, duration_limit=None, is_re_count=None, is_anonymous=False, user_group_ids=None, description=None, id=None):
        """
        TimeFlowConfigOutputDto - a model defined in Swagger
        """
    ...
    def time_flow_name(self):
        """
        Gets the time_flow_name of this TimeFlowConfigOutputDto.
        计费策略名。

        :return: The time_flow_name of this TimeFlowConfigOutputDto.
        :rtype: str
        """
    ...
    def time_flow_name(self, time_flow_name):
        """
        Sets the time_flow_name of this TimeFlowConfigOutputDto.
        计费策略名。

        :param time_flow_name: The time_flow_name of this TimeFlowConfigOutputDto.
        :type: str
        """
    ...
    def site_id(self):
        """
        Gets the site_id of this TimeFlowConfigOutputDto.
        站点ID，UUID格式。

        :return: The site_id of this TimeFlowConfigOutputDto.
        :rtype: str
        """
    ...
    def site_id(self, site_id):
        """
        Sets the site_id of this TimeFlowConfigOutputDto.
        站点ID，UUID格式。

        :param site_id: The site_id of this TimeFlowConfigOutputDto.
        :type: str
        """
    ...
    def enable_traffic_limit_mode(self):
        """
        Gets the enable_traffic_limit_mode of this TimeFlowConfigOutputDto.
        启用流量控制。

        :return: The enable_traffic_limit_mode of this TimeFlowConfigOutputDto.
        :rtype: bool
        """
    ...
    def enable_traffic_limit_mode(self, enable_traffic_limit_mode):
        """
        Sets the enable_traffic_limit_mode of this TimeFlowConfigOutputDto.
        启用流量控制。

        :param enable_traffic_limit_mode: The enable_traffic_limit_mode of this TimeFlowConfigOutputDto.
        :type: bool
        """
    ...
    def traffic_limit_mode(self):
        """
        Gets the traffic_limit_mode of this TimeFlowConfigOutputDto.
        流量限制方式（1---每天，2---每月，3---每周，4---每年），启用流量控制后必填。

        :return: The traffic_limit_mode of this TimeFlowConfigOutputDto.
        :rtype: int
        """
    ...
    def traffic_limit_mode(self, traffic_limit_mode):
        """
        Sets the traffic_limit_mode of this TimeFlowConfigOutputDto.
        流量限制方式（1---每天，2---每月，3---每周，4---每年），启用流量控制后必填。

        :param traffic_limit_mode: The traffic_limit_mode of this TimeFlowConfigOutputDto.
        :type: int
        """
    ...
    def traffic_limit(self):
        """
        Gets the traffic_limit of this TimeFlowConfigOutputDto.
        流量限制值（兆），启用流量控制后必填。

        :return: The traffic_limit of this TimeFlowConfigOutputDto.
        :rtype: float
        """
    ...
    def traffic_limit(self, traffic_limit):
        """
        Sets the traffic_limit of this TimeFlowConfigOutputDto.
        流量限制值（兆），启用流量控制后必填。

        :param traffic_limit: The traffic_limit of this TimeFlowConfigOutputDto.
        :type: float
        """
    ...
    def enable_duration_limit_mode(self):
        """
        Gets the enable_duration_limit_mode of this TimeFlowConfigOutputDto.
        启用时长控制。

        :return: The enable_duration_limit_mode of this TimeFlowConfigOutputDto.
        :rtype: bool
        """
    ...
    def enable_duration_limit_mode(self, enable_duration_limit_mode):
        """
        Sets the enable_duration_limit_mode of this TimeFlowConfigOutputDto.
        启用时长控制。

        :param enable_duration_limit_mode: The enable_duration_limit_mode of this TimeFlowConfigOutputDto.
        :type: bool
        """
    ...
    def duration_limit_mode(self):
        """
        Gets the duration_limit_mode of this TimeFlowConfigOutputDto.
        时长限制方式（1---每天，2---每月，3---每周，4---每年），启用时长控制后必填。

        :return: The duration_limit_mode of this TimeFlowConfigOutputDto.
        :rtype: int
        """
    ...
    def duration_limit_mode(self, duration_limit_mode):
        """
        Sets the duration_limit_mode of this TimeFlowConfigOutputDto.
        时长限制方式（1---每天，2---每月，3---每周，4---每年），启用时长控制后必填。

        :param duration_limit_mode: The duration_limit_mode of this TimeFlowConfigOutputDto.
        :type: int
        """
    ...
    def duration_limit(self):
        """
        Gets the duration_limit of this TimeFlowConfigOutputDto.
        时长限制值（分钟），启用时长控制后必填。

        :return: The duration_limit of this TimeFlowConfigOutputDto.
        :rtype: float
        """
    ...
    def duration_limit(self, duration_limit):
        """
        Sets the duration_limit of this TimeFlowConfigOutputDto.
        时长限制值（分钟），启用时长控制后必填。

        :param duration_limit: The duration_limit of this TimeFlowConfigOutputDto.
        :type: float
        """
    ...
    def is_re_count(self):
        """
        Gets the is_re_count of this TimeFlowConfigOutputDto.
        重认证后流量和时长清零并重新计算。

        :return: The is_re_count of this TimeFlowConfigOutputDto.
        :rtype: bool
        """
    ...
    def is_re_count(self, is_re_count):
        """
        Sets the is_re_count of this TimeFlowConfigOutputDto.
        重认证后流量和时长清零并重新计算。

        :param is_re_count: The is_re_count of this TimeFlowConfigOutputDto.
        :type: bool
        """
    ...
    def is_anonymous(self):
        """
        Gets the is_anonymous of this TimeFlowConfigOutputDto.
        策略适用于匿名账号。

        :return: The is_anonymous of this TimeFlowConfigOutputDto.
        :rtype: bool
        """
    ...
    def is_anonymous(self, is_anonymous):
        """
        Sets the is_anonymous of this TimeFlowConfigOutputDto.
        策略适用于匿名账号。

        :param is_anonymous: The is_anonymous of this TimeFlowConfigOutputDto.
        :type: bool
        """
    ...
    def user_group_ids(self):
        """
        Gets the user_group_ids of this TimeFlowConfigOutputDto.
        用户组ID列表。

        :return: The user_group_ids of this TimeFlowConfigOutputDto.
        :rtype: list[str]
        """
    ...
    def user_group_ids(self, user_group_ids):
        """
        Sets the user_group_ids of this TimeFlowConfigOutputDto.
        用户组ID列表。

        :param user_group_ids: The user_group_ids of this TimeFlowConfigOutputDto.
        :type: list[str]
        """
    ...
    def description(self):
        """
        Gets the description of this TimeFlowConfigOutputDto.
        计费策略描述。

        :return: The description of this TimeFlowConfigOutputDto.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this TimeFlowConfigOutputDto.
        计费策略描述。

        :param description: The description of this TimeFlowConfigOutputDto.
        :type: str
        """
    ...
    def id(self):
        """
        Gets the id of this TimeFlowConfigOutputDto.
        计费策略ID。

        :return: The id of this TimeFlowConfigOutputDto.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this TimeFlowConfigOutputDto.
        计费策略ID。

        :param id: The id of this TimeFlowConfigOutputDto.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, TimeFlowConfigOutputDto):
            return False
