...
class CommonResponseBody(object):
    """
    ...
    def __init__(self, errcode=None, errmsg=None):
        """
        CommonResponseBody - a model defined in Swagger
        """
    ...
    def errcode(self):
        """
        Gets the errcode of this CommonResponseBody.
        错误码。

        :return: The errcode of this CommonResponseBody.
        :rtype: str
        """
    ...
    def errcode(self, errcode):
        """
        Sets the errcode of this CommonResponseBody.
        错误码。

        :param errcode: The errcode of this CommonResponseBody.
        :type: str
        """
    ...
    def errmsg(self):
        """
        Gets the errmsg of this CommonResponseBody.
        错误信息。

        :return: The errmsg of this CommonResponseBody.
        :rtype: str
        """
        return self._errmsg
    ...
    def errmsg(self, errmsg):
        """
        Sets the errmsg of this CommonResponseBody.
        错误信息。

        :param errmsg: The errmsg of this CommonResponseBody.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CommonResponseBody):
            return False
