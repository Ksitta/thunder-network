...
class QueryResponse(object):
    ...
    def errcode(self):
        """
        Gets the errcode of this QueryResponse.
        错误码。

        :return: The errcode of this QueryResponse.
        :rtype: str
        """
    ...
    def errcode(self, errcode):
        """
        Sets the errcode of this QueryResponse.
        错误码。

        :param errcode: The errcode of this QueryResponse.
        :type: str
        """
        if errcode is not None and len(errcode) > 256:
            raise ValueError("Invalid value for `errcode`, length must be less than or equal to `256`")
    ...
    def errmsg(self):
        """
        Gets the errmsg of this QueryResponse.
        错误信息。

        :return: The errmsg of this QueryResponse.
        :rtype: str
        """
        return self._errmsg
    ...
    def errmsg(self, errmsg):
        """
        Sets the errmsg of this QueryResponse.
        错误信息。

        :param errmsg: The errmsg of this QueryResponse.
        :type: str
        """
