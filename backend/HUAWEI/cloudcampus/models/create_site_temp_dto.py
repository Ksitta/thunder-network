...
class CreateSiteTempDto(object):
    """
    ...
    def __init__(self, name=None, types=None, custom=False, config_identifies=None):
        """
        CreateSiteTempDto - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this CreateSiteTempDto.
        站点模板名称（不支持包括特殊字符' , : \"  ^ / < > = & % # ? + ! ）几项。

        :return: The name of this CreateSiteTempDto.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this CreateSiteTempDto.
        站点模板名称（不支持包括特殊字符' , : \"  ^ / < > = & % # ? + ! ）几项。

        :param name: The name of this CreateSiteTempDto.
        :type: str
        """
    ...
    def types(self):
        """
        Gets the types of this CreateSiteTempDto.
        站点模板类型列表，可为AP，LSW，FW。

        :return: The types of this CreateSiteTempDto.
        :rtype: list[str]
        """
        return self._types
    ...
    def types(self, types):
        """
        Sets the types of this CreateSiteTempDto.
        站点模板类型列表，可为AP，LSW，FW。

        :param types: The types of this CreateSiteTempDto.
        :type: list[str]
        """
    ...
    def custom(self):
        """
        Gets the custom of this CreateSiteTempDto.
        是否定制特性。

        :return: The custom of this CreateSiteTempDto.
        :rtype: bool
        """
        return self._custom
    ...
    def custom(self, custom):
        """
        Sets the custom of this CreateSiteTempDto.
        是否定制特性。

        :param custom: The custom of this CreateSiteTempDto.
        :type: bool
        """
    ...
    def config_identifies(self):
        """
        Gets the config_identifies of this CreateSiteTempDto.
        ...
        :return: The config_identifies of this CreateSiteTempDto.
        :rtype: list[str]
        """
    ...
    def config_identifies(self, config_identifies):
        """
        Sets the config_identifies of this CreateSiteTempDto.
        \"当custom为true时必填且不能为空，支持定制的特性，和站点模板类型有对应关系（所有站点模板类型都支持定制通用配置特性：   snmp -- SNMP、   clientdata -- 运维配置(O&M Parameters)、   bootrom -- BootROM、   time -- NTP时间(NTP Time)、   initloginuser -- 本地用户(Local User)； AP站点模板类型单独支持定制特性：   apssid -- AP SSID、   groupradio -- 射频(Radio)； FW站点模板类型单独支持定制特性：   fwtrafficpolicy -- 流量策略(Traffic Policy)、   fwsecureauth -- 认证(Authentication)、   fwssid -- FW SSID、   fwsecuritypolicy -- 安全策略(Security Policy)； LSW站点模板类型无单独支持的定制特性）。\" 

        :param config_identifies: The config_identifies of this CreateSiteTempDto.
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CreateSiteTempDto):
            return False
