...
class TimeInfo(object):
    ...
    def __init__(self, errcode=None, errmsg=None, data=None):
        """
        TimeInfo - a model defined in Swagger
        """
    ...
    def errcode(self):
        """
        Gets the errcode of this TimeInfo.
        错误码。

        :return: The errcode of this TimeInfo.
        :rtype: str
        """
    ...
    def errcode(self, errcode):
        """
        Sets the errcode of this TimeInfo.
        错误码。

        :param errcode: The errcode of this TimeInfo.
        :type: str
        """
    ...
    def errmsg(self):
        """
        Gets the errmsg of this TimeInfo.
        错误信息。

        :return: The errmsg of this TimeInfo.
        :rtype: str
        """
        return self._errmsg
    ...
    def errmsg(self, errmsg):
        """
        Sets the errmsg of this TimeInfo.
        错误信息。

        :param errmsg: The errmsg of this TimeInfo.
        :type: str
        """
    ...
    def data(self):
        """
        Gets the data of this TimeInfo.
        时间信息列表。

        :return: The data of this TimeInfo.
        :rtype: list[TimeTemplateDto]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this TimeInfo.
        时间信息列表。

        :param data: The data of this TimeInfo.
        :type: list[TimeTemplateDto]
        """
