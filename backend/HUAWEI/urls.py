...
from .views import site_views, user_views, eq_views, flow_views, assign_views, flow_generate_view, ssid_views, top_view, mail_views, ticket_views
...
urlpatterns = [
    ...
    url(r'^topflow/', top_view.TopSiteView.as_view(), name='top_site_flow'),
